        ...
        <section>
            ...
            <div class="card text-center" style="margin-top:10px;padding: 50px;background: transparent">
                <form class="form-inline" method="post" name="myForm" action="">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="number" name="tank_capacity" class="form-control" id="tank_capacity" placeholder="Tank Capacity" required>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="number" name="power" class="form-control" id="power" placeholder="Horse Power" required>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
...
if (isset($_POST['submit'])) {
    ...
    if ($car) { // if car exists
        ...
        $query = "INSERT INTO `car` (plate_id, model, year, out_of_service, price, color, power, `automatic`, tank_capacity, loc, img) VALUES('$plate_id','$model','$year','$out_of_service','$price','$color','$power','$isAutomatic','$tank_capacity','$location','$img')";
