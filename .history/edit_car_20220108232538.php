        ...
        <section>
            ...
            <div class="card text-center" style="margin-top:10px;padding: 50px;background: transparent">
                <form class="form-inline" method="post" name="myForm" action=""
                      onsubmit="return validateRegisterFormregisterCar()">
                    <div class="form-group mx-sm-3 mb-2">
                        <?php
                            echo '<input type="text" name="plateId" class="form-control" id="plateId" placeholder="Plate ID" value="'.$car["plate_id"].'">';
                        ?>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <?php
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <?php
                            echo '<input type="year" name="year" class="form-control" id="year" value="'.$car["year"].'">';
                        ?>
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="color" style="padding-right: 10;">Color</label>
                        <?php
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        ...
                        <?php
                            echo '<input type="number" name="tank_capacity" class="form-control" id="tank_capacity" value="'.$car["tank_capacity"].'">';
                        ?>     
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="power" style="padding-right: 10;">Power</label>
                        <?php
                            echo '<input type="number" name="power" class="form-control" id="power" value="'.$car["power"].'">';
                        ?>     
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <label for="price" style="padding-right: 10;">Price</label>
                        <?php
                            echo '<input type="number" name="price" class="form-control" id="price" value="'.$car["price"].'">';
                        ?>     
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE `car` SET plate_id='$plate_id', model='$model', year='$year', out_of_service='$out_of_service', price='$price', color='$color', power='$power', automatic='$isAutomatic', tank_capacity='$tank_capacity', loc='$location' WHERE plate_id='$plate_id'";
