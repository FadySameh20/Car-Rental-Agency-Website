...
<nav id="menu">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <?php if ($is_admin == 'T') { ?>
            ...
            <li class="nav-item"><a href="adv_search.php" class="nav-link">Advanced Search</a></li>
            <li class="nav-item"><a href="register_car.php" class="nav-link">Cars</a></li>
        <?php } else { ?>
            <li class="nav-item"><a href="payment.php" class="nav-link">Payment</a></li>
            <li class="nav-item"><a href="user_search.php" class="nav-link">Reservations</a></li>
        <?php } ?>
